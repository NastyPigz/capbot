...
void Db::put(json items, handle_function fn) {
...
void Db::get(std::string key, handle_function fn) {
...
void Db::del(std::string key, handle_function fn) {
...
void Db::post(json item, handle_function fn) {
    std::multimap<std::string, std::string> hdrs = headers;
    hdrs.insert(std::pair<std::string, std::string>("Content-Type", "application/json"));
...
void Db::patch(std::string key, json item, handle_function fn) {
    std::multimap<std::string, std::string> hdrs = headers;
    hdrs.insert(std::pair<std::string, std::string>("Content-Type", "application/json"));
...
void Db::query(json query, handle_function fn, unsigned int limit, std::string last) {
    std::multimap<std::string, std::string> hdrs = headers;
    hdrs.insert(std::pair<std::string, std::string>("Content-Type", "application/json"));
    json pl = {
        {"query", query}
